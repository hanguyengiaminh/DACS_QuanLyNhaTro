...
VALUES
(N'chutro01', N'pass123', N'Nguyễn Văn A', N'a@example.com', N'0912123456', N'Chủ trọ'),
(N'nhanvien01', N'pass456', N'Lê Thị B', N'b@example.com', N'0923456789', N'Nhân viên');


-- them chi tiet dich vu
INSERT INTO ChiTietDichVu (MaPhong, MaDichVu, ChiSoDau, ChiSoCuoi, SoLuong, ThanhTien, Thang, Nam)
VALUES
(2, 1, 100, 150, 50, 175000, 6, 2025),
(2, 2, 20, 25, 5, 75000, 6, 2025);


-- Thêm phòng trọ

-- Thêm phòng trọ
INSERT INTO PhongTro (MaKhuVuc, PhongSo, DienTich, GiaThue, SoLuongToiDa, TrangThai, NguoiTao)
VALUES
(1, N'A101', 25.5, 2500000, 3, N'Trống', 2),
(1, N'A102', 20.0, 2000000, 2, N'Đã cho thuê', 2);


-- Thêm người thuê
INSERT INTO NguoiThue (HoTen, CCCD, NgaySinh, GioiTinh, SoDienThoai, Email, DiaChi, NguoiTao)
VALUES
(N'Trần Văn C', N'123456789012', '1995-05-10', N'Nam', N'0933123456', N'c@example.com', N'Quận 5, TP.HCM', 2),
(N'Phạm Thị D', N'234567890123', '1998-03-22', N'Nữ', N'0944234567', N'd@example.com', N'Quận 7, TP.HCM', 2);

-- them hopdong thue--
INSERT INTO HopDongThue (MaPhong, MaNguoiThue, NgayBatDau, NgayKetThuc, TienCoc, TrangThai, NguoiTao)
VALUES
(2, 1, '2025-06-01', '2026-06-01', 2000000, N'Đang hiệu lực', 2);


-- lich su thue
INSERT INTO LichSuThue (MaPhong, MaNguoiThue, MaHopDong, NgayBatDau, NgayKetThuc)
VALUES
(2, 1, 1, '2025-06-01', '2026-06-01');
 --log hoat dong

 INSERT INTO LogHoatDong (MaNguoiDung, ThaoTac, BangDuLieu, MaBanGhi, MoTa, DiaChiIP, ThietBi)
VALUES
(2, N'Thêm', N'PhongTro', 1, N'Tạo phòng mới A101', N'192.168.1.2', N'Windows 10 - Chrome');
...
VALUES
(N'Điện', N'kWh', 3500, N'Tiền điện theo công tơ'),
(N'Nước', N'm³', 15000, N'Nước sinh hoạt'),
(N'Internet', N'Tháng', 100000, N'Cáp quang tốc độ cao');
...
-- Thêm hóa đơn
INSERT INTO HoaDon (MaPhong, MaNguoiThue, NgayLap, Thang, Nam, TongTien, NguoiLap)
VALUES
(2, 1, '2025-06-10', 6, 2025, 2500000 + 175000 + 75000, 2);



-- Thêm chi tiết hóa đơn
INSERT INTO ChiTietHoaDon (MaHoaDon, MaDichVu, SoLuong, DonGia, ThanhTien)
VALUES
(1, 1, 50, 3500, 175000),
(1, 2, 5, 15000, 75000);
...
--tổng tiền thuê cho một phòng cụ thể trong một tháng cụ thể--
SELECT SUM(TongTien) AS TongTien
FROM HoaDon
WHERE MaPhong = 1 AND Thang = 6 AND Nam = 2025;
